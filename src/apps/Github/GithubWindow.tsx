...
export default function GithubWindow() {
  return (
    <div class='bg-zinc-700 flex flex-col items-center justify-center h-full w-full rounded-b-md'>
        ...
        <a href='https://github.com/whiteneone00' class='text-gray-400 hover:text-white text-2xl mb-4 hover:scale-105 transition' target='_blank'>github.com/whiteneone00</a>
    </div>
  )
}
