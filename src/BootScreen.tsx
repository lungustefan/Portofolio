...
export default function BootScreen(props:{status:number}) {
  return (
    <div class='absolute top-0 z-50 left-0 flex flex-col gap-5 bg-zinc-900 w-full h-screen items-center justify-between'>
        ...
        <p class='text-md text-center w-full text-gray-500 mb-5'>Copyright © {new Date().getFullYear()} <a href='https://github.com/jadify-eu' target='_blank'>Arda Murtezan</a> {t('copyright')}</p>
    </div>
  )
}
