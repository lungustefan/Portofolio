  ...
  return (
    <div class='bg-slate-700 text-white rounded-md pt-12 h-full w-full flex flex-col items-center text-center text-md'>
      ...
      <div class='flex flex-col gap-2 w-full h-full p-5 text-start text-md font-light'>
        ...
        <div class='h-full'/>
        <p class='text-sm text-center w-full text-gray-500'>Copyright © {new Date().getFullYear()} <a href='https://github.com/lungustefan/Portofolio' target='_blank'>Lungu Stefan & Arda Murtezan</a> {t('copyright')}</p>
